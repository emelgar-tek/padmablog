...
?>
<h2 class="widgettitle"><span class="content_title"><?php comments_number(__( 'Leave A Reply', THEMEDOMAIN ), __( 'Comment', THEMEDOMAIN ), '% '.__( 'Comments', THEMEDOMAIN )); ?></span></h2><br class="clear"/>
<?php 
//Display Comments
if( have_comments() ) : ?> 
