...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post_wrapper">
	    ...
	    <div class="post_content_wrapper">
	    	...
	    	if(!empty($tg_blog_feat_content) OR $post_ft_type == 'Vimeo Video' OR $post_ft_type == 'Youtube Video')
	    	{  
			    switch($post_ft_type)
			    {
			    	case 'Image':
			...
			<div id="post_share_text" class="post_share_text"><i class="fa fa-share"></i><?php echo _e( 'Share', THEMEDOMAIN ); ?></div>
			<br class="clear"/>
			...
			if ($tags) {
			 ...
			 ?>
			  	<h2 class="widgettitle"><span class="content_title"><?php echo _e( 'You might also like', THEMEDOMAIN ); ?></span></h2>
