    ...
    <ul>
        ...
        <?php
		 ...
		 <?php
		    ...
		    {
		?>
		<li class="snapchat"><a <?php if(!empty($tg_topbar_social_link)) { ?>target="_blank"<?php } ?> title="snapchat" href="<?php echo esc_url($pp_snapchat_url); ?>"><i class="fa fa-snapchat"></i></a></li>
		<?php
		    }
		?>
    </ul>
